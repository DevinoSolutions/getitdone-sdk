 ...
 * `definePublicRoute` descriptors in `@getitdone/api-contracts` — the same
 * objects that build the server handler and the OpenAPI spec (open-api D7).
 * A wire-contract change recompiles into the SDK types with zero hand-kept
